...
#define PREHEAT_5_LABEL       "TEA"  // complete bullshit just for testing
#define PREHEAT_5_TEMP_HOTEND 100
...
#define FAN_SOFT_PWM  // edit: enabled because terminal yelled at me
